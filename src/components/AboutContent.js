    ...
    return (
        <div><div className="content-about" >
            <div data-aos="zoom-in"
                data-aos-easing="ease-in-sine" ><img className="blrImage" src={IEEELOGO}></img></div>
        ...
        <div className='blrSection'>
                ...
                <div className='content-about2'>
                    <div data-aos="zoom-in"
                        ...
                        data-aos-easing="ease-in-sine" > IEEE Bangalore Section was established in 1977 and is one of the most vibrant and dynamic IEEE Section across globe.
            ...
            <div className="content-about">
                <div data-aos="zoom-in"
                    data-aos-easing="ease-in-sine" ><img className="blrImage" src={logo}></img></div>
                <div className='content-about' data-aos="zoom-in"
                    data-aos-easing="ease-in-sine" >
                    {IEEEDATA}
                    <div>l</div>
